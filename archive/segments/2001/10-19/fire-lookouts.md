...
date: '2001-10-19'
category: Segments
summary: Once there were five-thousand of them. But due to technology, the number of fire lookouts has dwindled to just a few hundred. Jeff Rice reports on what drives the people who belong to this vanishing breed to keep vigil over the forests of the West.
---
<!-- source: https://loe.org/shows/segments.html?programID=01-P13-00042&segmentID=5 -->
...
{% cue text="MUSIC: Wagner's &quot;Ride of the Valkyries&quot;" %}
...
{% cue text="CRIST TALKING TO DISPATCH" %}
...
- [National Historic Lookout Register](http://firetower.org/index.html)
- [Forest Fire Lookout Association](http://firelookout.org/)
- [Forest Fire Lookout Museum in Spokane, WA](http://www.firelookout.com/lomuseum.html)
