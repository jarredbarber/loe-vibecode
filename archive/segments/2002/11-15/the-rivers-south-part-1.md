---
title: The Rivers South, Part 1
slug: the-rivers-south-part-1
date: '2002-11-15'
category: Segments
...
---
<!-- source: https://loe.org/shows/segments.html?programID=02-P13-00046&segmentID=1 -->
...
{% cue text="TRUCK DRIVING OVER LAND" %}
...
{% cue text="WALKING THROUGH WOODS" %}
...
{% cue text="SOUND OF WATER FLOWING" %}
...
{% cue text="WATER FLOWING MORE FIERCELY" %}
...
{% cue text="CRICKETS CHIRPING AND A DOG BARKING IN THE DISTANCE" %}
...
{% cue text="SOUND OF CONSTRUCTION MACHINERY" %}
...
{% cue text="WATER SPRINKLERS TURNING" %}
...
{% cue text="MUSIC: Kelly Joe Phelps, “I’ve Been Converted” LEAD ME ON (Burnside Record, 1994)" %}
