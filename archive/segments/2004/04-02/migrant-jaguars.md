---
title: Migrant Jaguars
slug: migrant-jaguars
date: '2004-04-02'
category: Segments
image_url: https://loe.org/images/content/thisweek/040402jaguars_childs.jpg
image_caption: 'Jaguar photo, taken at night, December 2001 in Arizona near the Mexican border. (Photo: Jack Childs)'
summary: Jaguars, the animal, not the car, used to inhabit the southwestern U.S. And sometimes a few of the big cats that live in Mexico cross the border into the States. The crossings have sparked a debate about whether to re-introduce jaguars to the U.S. From Tucson, Barbara Ferry reports.
---
<!-- source: https://loe.org/shows/segments.html?programID=04-P13-00014&segmentID=4 -->
...
{% cue text="SOUND OF CAMERA REWINDING" %}
...
{% cue text="MUSIC: Jimi Hendrix “Changes” BAND OF GYPSYS (Capitol – 1970)" %}

## Related Links

- [Northern Jaguar Project](http://www.sonoranjaguar.org/)
- [The Arizona Game and Fish Department's jaguar web page](http://www.gf.state.az.us/w_c/jaguar_management.html)
