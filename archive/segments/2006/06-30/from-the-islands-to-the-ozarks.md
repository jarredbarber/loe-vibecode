---
title: From the Islands to the Ozarks
slug: from-the-islands-to-the-ozarks
date: '2006-06-30'
category: Segments
summary: Many Marshall Islanders, transplanted to Arkansas’ Ozark Mountains, carry the legacy of post-World War II atomic testing. Some continue to suffer poverty and illness. Jacqueline Froelich reports from Fayetteville, Arkansas.
---
<!-- source: https://loe.org/shows/segments.html?programID=06-P13-00026&segmentID=6 -->
...
{% cue text="SOUND OF INSECTS, CHILD’S VOICE CALLING" %}
...
![Tony Debrum holding honorary nephew, Lucas Sherman, aboard the "Oleander"near Majuro. (Photo: Jessica Reimers-Langijota)](https://loe.org/images/content/051021/Lucas\&UncleTony.gif)
...
{% cue text="BELL RINGING AND RECITATION OF NAMES OF THE DEAD" %}
...
{% cue text="CHURCH YOUTH CHOIR; INCANTATIONS" %}
...
{% cue text="CHURCH YOUTH CHOIR" %}

FROELICH: This year, Chong-Gum, for the first time, showed a documentary film about the Bravo Test.

{% cue text="HISTORIC FILM SOUNDTRACK: ‘COUNTDOWN 12, 11, 10, 9…ZERO…EXPLOSION…" %}
...
{% cue text="MARSHALLESE ANTHEM SUNG AT VICTIMS DAY EVENT" %}
...
- [Republic of the Marshall Islands information](http://www.yokwe.net)
