---
title: Family Farmacia
slug: family-farmacia
date: '2009-08-28'
category: Segments
summary: Traditional Mexican botanical medicine was alive and well when Antony Jauregui (HOW-re-gee) was growing up in Los Angeles. Now the Youth Radio reporter is trying to make sure he learns everything he can about it from his mother and other Latino naturalists.
---
<!-- source: https://loe.org/shows/segments.html?programID=09-P13-00035&segmentID=4 -->
...
{% cue text="SOUND OF WATER RUNNING" %}
...
{% cue text="SOUND OF POURING WATER" %}

JAUREGUI: I put it in my mug and we can make some dandelion coffee.

{% cue text="SOUND OF SILVERWARE TOUCHING MUG" %}

JAUREGUI: And now I'm going to have a little sip.

{% cue text="SOUND OF SIPPING TEA AND SIGH OF SATISFACTION" %}
...
- [Youth Radio](https://loe.org/shows/www.youthradio.org)
