---
title: Protecting a Forest and Preserving a Culture
slug: protecting-a-forest-and-preserving-a-culture
date: '2012-09-14'
category: Segments
...
---
<!-- source: http://www.loe.org/shows/segments.html?programID=09-P13-00049&segmentID=3 -->
...
{% cue text="CLICKING SOUNDS ON COMPUTER" %}
...
{% cue text="ALMIR SPEAKING PORTUGUESE" %}
...
{% cue text="CHOPPING SOUNDS CONTINUE" %}
...
{% cue text="GRASS CRUNCHING; WALKING SOUNDS" %}
...
{% cue text="SOUNDS OF BREATHING AIR IN" %}
...
{% cue text="WALKING NOISES; ALMIR SPEAKING PORTUGUESE" %}
...
{% cue text="CARDOZE SPEAKING PORTUGUESE" %}
...
{% cue text="CHIEF ALMIR’S MOTHER SPEAKING SURUI" %}
...
{% cue text="VOICES TALKING; VILLAGE SOUNDS" %}
...
{% cue text="MUSIC: Baden Powell “Estorias De Alcantara” from ‘Baden Powell: Three Originals’ (MPS Records - 1975)" %}
...
- [Ivaneide Cardozo's NGO Kaninde works with the Surui on the REDD forest project](http://www.kaninde.org.br)
- [Indegenous Environmental Network Opposes the REDD Scheme](http://www.ienearth.org/)
- [Amazon Conservation Team](http://www.amazonteam.org/)
