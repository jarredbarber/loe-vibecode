...
slug: sound-in-the-sea
date: '2014-08-22'
category: Segments
summary: The ocean is a noisy place and human activity is making it worse. Jennifer Jerrett reports that biologists studying the role sound plays in the sea are making surprising discoveries among some squishy marine life forms.
---
<!-- source: https://loe.org/shows/segments.html?programID=14-P13-00034&segmentID=5 -->
...
{% cue text="SOUNDS OF D-TAG SIGNAL AND BOAT SPLASHING ON WAVES. MAX BERNARD OFF MIC: &quot;SO ARAN, ARE YOU READY?&quot;" %}
...
{% cue text="SOUNDS OF PLACING THE TAG. PERSON ON THE BOAT SAYING “THERE YOU GO!&quot;" %}
...
{% cue text="SOUNDS OF DOLPHIN CLICKS" %}
...
{% cue text="MORE DOLPHIN CLICKS" %}

JERRETT: To put it in human terms, they basically ‘see’ with sound. And dolphins also use sound to communicate.

{% cue text="SPLASHING AND DOLPHIN CHIRPS, THEN LOW-FREQUENCY RUMBLING SOUND OF BLUE WHALE" %}
...
{% cue text="OFFSHORE INDUSTRIAL NOISE" %}
...
{% cue text="SWISH SOUND OF DOLPHIN SWIMMING FOLLOWED BY SOUND OF VESSEL FAR AWAY" %}

JENSEN: So now you can hear the vessel approaching.

{% cue text="SOUNDS OF VESSEL GETTING CLOSER, PASSING AND MOVING AWAY" %}
...
{% cue text="SOUNDS OF SNAPPING SHRIMP AND DACYLLUS" %}
...
{% cue text="QUIET AMBIENCE OF NANTUCKET SOUND" %}
...
- [Follow Jennifer Jerrett’s work on this story and others on SoundCloud](https://soundcloud.com/jennifer-jerrett/sound-in-the-sea)
