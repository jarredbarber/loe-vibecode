---
title: The Sounds of Mars
slug: the-sounds-of-mars-0527
date: '2022-05-27'
category: Segments
...
---
<!-- source: https://loe.org/shows/segments.html?programID=22-P13-00021&segmentID=6 -->
...
{% cue text="SFX: “THE MARTIAN” AUDIO" %}
...
[YouTube video player](https://www.youtube.com/embed/GHenFGnixzU)

{% cue text="SFX: FIRST SOUNDS FROM MARS – RAW AUDIO" %}
...
{% cue text="SFX: ROVER DRIVING ON MARS – FILTERED" %}
...
{% cue text="SFX: HELICOPTER FLYING ON MARS" %}

BASCOMB: Now, Mars has a different atmosphere than Earth, so that’s sure to alter how sound waves move, right?

![In this photo, the Ingenuity helicopter is deployed from underneath the Perseverance rover. (Photo: NASA, public domain)](https://loe.org/content/2022-05-27/MARS_helicopter.jpg)
...
{% cue text="SFX: EARTH BIRDS" %}

get lost on Mars.

{% cue text="SFX: MARS BIRDS" %}
...
{% cue text="SFX: EARTH BIKE BELL" %}

gets muffled on the red planet.

{% cue text="SFX: MARS BIKE BELL" %}
...
![The Perseverance rover is now moving up the slope of the Jezero crater, looking for new rock samples. (Photo: NASA, public domain)](https://loe.org/content/2022-05-27/MARS_crater.jpg)
...
{% cue text="SFX: LOE THEME, MARS VERSION" %}
...
- [Find out more about the audio captured on Mars at NASA’s website](https://mars.nasa.gov/mars2020/participate/sounds/?playlist=mars&item=mars-helicopter-flying&type=mars)
