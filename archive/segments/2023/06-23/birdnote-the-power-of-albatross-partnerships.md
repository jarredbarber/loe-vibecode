...
DOERING: The queerness in nature extends to birds, too. Wenfei Tong has this BirdNote about how sexual fluidity helps some seabirds raise the next generation.

BirdNote®  
The Power of Albatross Partnerships

For most albatross species, raising a chick is a real challenge. Waved Albatrosses produce such slow-growing, needy offspring that females lay only a single egg every two years. And both parents need to share the load until youngsters can hunt on their own.

{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/203698321/audio", label="Waved Albatross", duration="0:16-:19" %}
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/116338191/audio", label="Wandering Albatross", duration="3:14-3:18" %}
...
![Albatrosses tend to mate for life and can live more than 50 years. (Photo: Sidney Bragg, CC)](https://loe.org/content/2021-04-16/BIRDNOTE-Waved-Albatross-Pair-800-Sidney-Bragg-CC.jpg)

{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/959/audio", label="Laysan Albatrosses", duration=":24-:31" %}
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/32669/audio", label="Juvenile Laysan Albatross", duration=":06-:12" %}
...
DOERING: For pictures, soar on over to the Living on Earth website, loe.org.

## Related Links

- [Find this story and many more on the BirdNote® website](https://www.birdnote.org/listen/shows/power-albatross-partnerships)
- [Learn more about the Waved Albatross](https://abcbirds.org/bird/waved-albatross/)
- [Learn more about the Laysan Albatross](https://abcbirds.org/bird/laysan-albatross/)
