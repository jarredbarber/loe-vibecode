...
DOERING: The wild cousins of the centerpiece on many Thanksgiving tables do more than just gobble. Turkeys squawk –

{% cue text="FLUTTERING AND SQUAWKING SFX, Jay McGowan / Macaulay Library at the Cornell Lab of Ornithology" %}

DOERING: Chirp when they’re poults, or chicks –

{% cue text="CHICKS AND HEN CALLING SFX, Jay McGowan / Macaulay Library at the Cornell Lab of Ornithology" %}

DOERING: And even softly “purr” to express contentment in a flock.

{% cue text="TURKEY ‘PURR’ SFX, Geoffrey Keller / Macaulay Library at the Cornell Lab of Ornithology" %}

DOERING: And of course, there’s the gobble itself.

{% cue text="TURKEY GOBBLES SFX, Brian Sullivan / Macaulay Library at the Cornell Lab of Ornithology" %}
...
{% cue text="MUSIC: Marcus Roberts, “Let It Snow, Let It Snow, Let It Snow” on A Merry Jazzmas, BMG Music" %}

## Related Links

- [Learn more about wild turkeys here](https://www.allaboutbirds.org/guide/Wild_Turkey/sounds#)
- [Read about the many different calls of wild turkeys](https://www.nwtf.org/content-hub/the-sounds-of-the-wild-turkey)
