...
date: '2002-09-20'
category: Segments
summary: Americans are so pinched for time and so stressed, camping is suddenly too much work. Maybe we're just getting lazier. Robin White reports on the blurring line between camping and the spa vacation.
---
<!-- source: https://loe.org/shows/segments.html?programID=02-P13-00038&segmentID=6 -->
...
{% cue text="SOUND OF BIRDS CHIRPING AND RUSTLING LEAVES" %}
...
{% cue text="CHIRPING CRICKETS AND RUSTLING PAPER" %}
