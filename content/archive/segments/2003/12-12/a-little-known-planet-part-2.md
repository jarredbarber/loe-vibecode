---
title: A Little Known Planet, Part 2
slug: a-little-known-planet-part-2
date: '2003-12-12'
category: Segments
image_url: https://loe.org/images/content/thisweek/031212borda.jpg
image_caption: 'Liz Borda searches for leeches in Madagascar. (Photo: Mark Siddall)'
summary: Nine years ago, the National Science Foundation launched a grant program to help pull the basic science of species identification out of the scientific backwaters. The initiative funds graduate students in particularly hard hit fields of taxonomy. Living on Earth’s Diane Toomey tagged along with one such student and her professor.
---
<!-- source: https://loe.org/shows/segments.html?programID=03-P13-00050&segmentID=2 -->
...
{% cue text="TUBES CLINKING TOGETHER" %}
...
{% cue text="SOUNDS OF WADING, SPLASHING" %}
...
{% cue text="WATER SPLASHING AND BIRDS CAWING" %}
...
{% cue text="WATER SLOSHING, BIRD CAWING" %}
...
{% cue text="CROWD NOISE, COUNTRY MUSIC" %}
...
{% cue text="TREES RUSTLING, BIRDS CALLING" %}
