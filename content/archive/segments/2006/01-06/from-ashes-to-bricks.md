---
title: From Ashes to Bricks
slug: from-ashes-to-bricks
date: '2006-01-06'
category: Segments
summary: Even with the closure of the Mojave power plant, coal and coal waste are a major economic force in Navajo country. And as Daniel Kraker reports from Arizona, Navajos have found a new way to use coal plant waste from ANOTHER power plant. They're making a new kind of concrete that could even help solve the reservation's acute housing shortage.
---
<!-- source: https://loe.org/shows/segments.html?programID=06-P13-00001&segmentID=3 -->
...
{% cue text="RAPPING SOUND" %}

OSTAPUK: So, that’s rapping.

{% cue text="TRUCK SOUND" %}
...
![This home, built with flexcrete blocks, will be fireproof and wind-tested to 200 mph. (Photo: Gary Damron)](https://loe.org/images/content/060106/flex-crete-225.gif)

{% cue text="SAWING SOUND" %}
...
{% cue text="SOUND OF PUMPING WATER AND PEOPLE TALKING" %}

![(Courtesy of the ASU Stardust Center for Affordable Homes and the Family.)](https://loe.org/images/content/060106/Work-in-Progress.gif)
...
![The original Augustine residene that was demolished and replaced (left photo). Mary and Key Augustine's new home (right). (Photos courtesy of the ASU Stardust Center for Affordable Homes and the Family.)](https://loe.org/images/content/060106/flexcretehouses.gif)
...
- [Stardust Center for Affordable Homes and the Family](http://www.asu.edu/stardust/)
