---
title: 'BirdNote: Just Whose Ducklings Are Those?'
slug: birdnote-just-whose-ducklings-are-those
date: '2017-05-12'
category: Segments
image_url: https://loe.org/content/2017-05-12/BIRDNOTE-Wood-Duck-with-babies-Curtis-CC.jpg
image_caption: 'A female Wood Duck’s young may not all be her own, thanks to nest parasitism. (Photo: Curtis, Creative Commons)'
summary: Wood Ducks avoid putting all their eggs in one basket – literally, by laying some of them in other ducks’ nests as an insurance policy in case disaster strikes their own nests. BirdNote’s Mary McCann explains that the duck that ends up with extra ducklings may not always be able to tell when she’s caring for alien brood.
---
<!-- source: https://loe.org/shows/segments.html?programID=17-P13-00019&segmentID=4 -->

## Transcript

{% cue text="MUX - BIRDNOTE® THEME" %}
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/179353/audio", label="Juvenile Wood Duck call", duration="0.09-.13" %}
...
![Goldeneye ducks are sometimes unwitting foster parents to the young of sneaky, egg-dumping Wood Duck females. (Photo: Gregg Thompson)](https://loe.org/content/2017-05-12/BIRDNOTE-Barrow's-Goldeneye-and-ducklings-Gregg-Thompson.jpg)
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/163898/audio", label="Female Hooded Merganser call", duration="0.19-.22" %}
...
{% cue text="primary information source: Birds of North America Online" %}
...
- [Listen on the BirdNote website](http://birdnote.org/show/just-whose-ducklings-are-those)
- [More about Wood Ducks from the Cornell Lab of Ornithology’s All About Birds](https://www.allaboutbirds.org/guide/Wood_Duck/id 	)
