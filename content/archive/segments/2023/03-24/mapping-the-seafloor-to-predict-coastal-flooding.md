...
![(On left): level of detail available on existing maps of shallow water near Florida’s St. Pete beach. (On right): hyper-detailed sonar images that USF is creating of the same area. (Image: USF College of Marine Science)](https://loe.org/content/2023-03-24/LEVIN-StPete_MapVsSonar.jpg)
...
![The miniature sonar device aboard SeaTrac's uncrewed vehicle can pick up minute details in shallow water—like the ghostly outline of a manatee, seen here. (Image: David Levin)](<https://loe.org/content/2023-03-24/LEVIN-outline of a manatee.JPG>)
...
![In a makeshift control room on the USF campus, scientists watch sonar and video data arrive in real-time from an autonomous uncrewed vehicle. (Image: David Levin)](https://loe.org/content/2023-03-24/LEVIN-USFControlRoom.jpeg)
...
![Engineer Jigger Herman programs the autonomous vessel’s course remotely from USF’s control room. Using a live video feed from the boat, he can take control manually at any time. (Image: David Levin)](<https://loe.org/content/2023-03-24/LEVIN-Jigger Herman remotely controlling vessel.JPG>)
...
![After a long day of logging data, engineer Hobie Boeschenstein begins to pull the autonomous uncrewed vessel back out of the water. (Image: David Levin)](<https://loe.org/content/2023-03-24/LEVIN-pulling autonomous vessel out of water.JPG>)
...
- [COMIT, the Center for Ocean Mapping and Innovative Technologies](https://www.marine.usf.edu/comit/)
- [Find more episodes of the “Deep Soundings” podcast](https://exchange.prx.org/series/43646-deep-soundings-stories-from-the-ocean-floor)
- [About Science Reporter David Levin](https://www.therealdavidlevin.com/)
