...
DOERING: So, Steve, you may remember that in September of last year, Living on Earth’s very own Aynsley O’Neill and I spent some time inoculating a log with shiitake mushroom spawn.

CURWOOD: Right, you wanted to grow a few in your backyard garden. A year or so later, any updates?

DOERING: Well, we did successfully grow and harvest some mushrooms…

CURWOOD: You sound a little uncertain there, Jenni.

DOERING: Well, okay, it all started out fine. I invited Aynsley over when I first noticed that they had sprouted up…

{% cue text="OUTDOOR AMBI" %}
...
DOERING: Yeah, there’s a chance we left it a little too long. They also were looking a little dried out…
...
O'NEILL: And I think we should, you know, definitely make sure to identify the mushrooms before we eat them anyway, just in case.
...
CURWOOD: Right, well of course you really have to be careful with identification when foraging mushrooms out and about, but I suppose you’d still want to be cautious with this backyard crop. I mean, these should be shiitakes, but what if something else snuck into the log?

![Wild shiitakes growing on a log. (Photo: Ezonokuma, Wikimedia Commons, CC BY-SA 3.0)](https://loe.org/content/2024-11-22/MUSHROOM_wild.jpg)

DOERING: Right, a backyard isn’t a sterile environment. We gave those shiitakes a head start so they likely would have outcompeted anything else, but it’s always good to check. Especially if you’re going to be cooking them up like we were!

CURWOOD: And, Jenni, what are your culinary plans here? There are so many ways to prepare mushrooms, what are you thinking?

DOERING: Well, we didn’t want to complicate the flavor too much, so we stuck with a very simple recipe.

{% cue text="KITCHEN AMBI" %}

DOERING: I think we can cook them up with some onion, green onion, salt and pepper, and see how they taste.
...
{% cue text="CHOPPING SFX" %}

O'NEILL: Our ratios might be a little off. That's fine.

DOERING: Yeah.

O’NEILL: Onion, scallion, mushrooms, it's all tasty. And part of our goal is to have the taste of the mushrooms shine through.
...
DOERING: Luckily, there aren’t too many poisonous mushrooms that look like shiitakes. But we weren’t taking any chances!

![The harvested shiitakes. (Photo: Aynsley O’Neill)](https://loe.org/content/2024-11-22/MUSHROOM_shiitakes.jpg)

CURWOOD: How did you do your sleuthing?
...
O'NEILL: I love picturing somebody sitting at their desk with a head set on with a big book of my ecology next to them, ready to identify at any given moment.
...
DOERING: Right, so after that, we did some online research on some mushroom identification sites and sent pictures to some amateur mycologist friends. And I’m happy to report that everyone came to the same conclusion!
...
{% cue text="PEPPER MILL SFX" %}

![Shiitakes for sale at a market, with a very uniform size and shape. (Photo: Peachyeung316, Wikimedia Commons, CC BY-SA 4.0)](https://loe.org/content/2024-11-22/MUSHROOM_forsale.jpg)
...
DOERING: Yeah, so a little bit of scallion, delicious.

O'NEILL: Fresh scallions, too. From the garden.

DOERING: Yes, straight from the garden. Bon appetit. Cheers, cheers.
...
DOERING: I could also use the rest in some pasta, like, for sure, parmesan and some butter, you know, something simple.
...
O'NEILL: Yeah, you really set it and forget it the way they say.
...
CURWOOD: Well, I am in full agreement – please bring some in for the whole crew to try next harvest!

DOERING: Copy that, Steve!

## Related Links

- [Listen to LOE’s previous coverage of a backyard mushroom kit here](https://www.loe.org/shows/segments.html?programID=23-P13-00039&segmentID=6)
- [Learn more about the process of growing mushrooms on a log](https://www.wildabundance.net/blog/how-to-grow-mushrooms-on-logs/)
