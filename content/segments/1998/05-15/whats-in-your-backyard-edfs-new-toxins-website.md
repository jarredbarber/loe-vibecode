---
title: 'What''s in Your Backyard?: EDF''s New Toxins Website'
slug: whats-in-your-backyard-edfs-new-toxins-website
date: '1998-05-15'
category: Segments
summary: Who are the major polluters in your community? As a citizen, you're entitled to know. The government requires most high- volume facilities to report how much of certain chemicals they're releasing into the environment. But these Toxic Release Inventory reports can be difficult to track down and even more difficult to understand. But a new site on the internet is changing all that. The Environmental Defense Fund has collected all the Toxic Release Inventory forms from around the country, entered them into a computer database, and added information about health effects. Steve Curwood logs on to www.scorecard.org. with David Roe from the Environmental Defense Fund.
---
<!-- source: https://loe.org/shows/segments.html?programID=98-P13-00020&segmentID=4 -->
