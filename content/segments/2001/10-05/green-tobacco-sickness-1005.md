...
slug: green-tobacco-sickness-1005
date: '2001-10-05'
category: Segments
summary: While the dangers of smoking are well known, tobacco also poses a health threat to those who pick it. Leda Hartman reports from North Carolina.
---
<!-- source: https://loe.org/shows/segments.html?programID=01-P13-00040&segmentID=6 -->
...
{% cue text="SALVADOR SPEAKING SPANISH" %}
...
{% cue text="SOUND OF VOMITING SCENE" %}
...
{% cue text="FIGUEROA SPEAKING SPANISH" %}
