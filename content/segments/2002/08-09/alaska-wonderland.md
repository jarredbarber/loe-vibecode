---
title: Alaska Wonderland
slug: alaska-wonderland
date: '2002-08-09'
category: Segments
summary: The Copper River Delta in Alaska is one of the last truly wild places in the country. Producer Guy Hand rafts down river, and tells a story of unexpected personal discovery.
---
<!-- source: https://loe.org/shows/segments.html?programID=02-P13-00032&segmentID=8 -->
...
{% cue text="SOUNDS OF RUSHING WATER" %}
...
{% cue text="SOUND OF LAUGHING RAFT-MATES" %}
...
{% cue text="MUSIC FADES, SOUND OF RIVER COMES UP" %}
...
{% cue text="SOUND OF SHOUTING AND ECHOES" %}
...
{% cue text="OOHS AND AAHS AS GLACIER BREAKS" %}
