...
date: '2002-10-04'
category: Segments
image_url: https://loe.org/images/content/thisweek/021004family_ties.jpg
summary: We hear a lot about the loss of family farms, but less about those that are making it. Some of their struggles are not financial, but familial. Robin White provides a view from inside.
---
<!-- source: https://loe.org/shows/segments.html?programID=02-P13-00040&segmentID=11 -->
...
{% cue text="SQUEAKING BRANCH OUTDOORS" %}
...
{% cue text="SOUNDS OF BARKING DOGS" %}
...
{% cue text="FOOTSTEPS CRUNCHING GRAVEL" %}
...
{% cue text="MUSIC: Miles Davis, &quot;Yestersnow&quot; A TRIBUTE TO JACK JOHNSON (Columbia, 1992)" %}
