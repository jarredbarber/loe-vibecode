---
title: Prairie Pothole Wetland
slug: prairie-pothole-wetland
date: '2005-04-15'
category: Segments
image_url: https://loe.org/images/content/thisweek/050415marshwren.jpg
summary: Spring comes alive in central North Dakota, near the Chase Lake National Wildlife Refuge. Nature recordist and photographer Lang Elliott gives Living on Earth host Steve Curwood a tour of a cattail marsh and the birds we’re likely to find there.
---
<!-- source: https://loe.org/shows/segments.html?programID=05-P13-00015&segmentID=9 -->

## Transcript

{% cue text="BIRDS CHIRPING IN WETLAND - FADES UNDER" %}
...
{% cue text="PUMPER LUNK, GULPING SOUND OF BITTERN" %}
...
{% cue text="PUMPING SOUND OF BITTERN" %}
...
{% cue text="WHINNY, OUTBURST CHIRPS FROM A SORA" %}
...
{% cue text="YELLOW-HEADED BLACKBIRDS CACKLE" %}
...
{% cue text="SOUNDS OF WILLET CALL" %}
...
{% cue text="BIRDS CHIRPING AND CALLING" %}

## Related Links

- [NatureSound Studio](http://www.naturesound.com/corepage/core.html)
- [Chase Lake National Wildlife Refuge](http://arrowwood.fws.gov/chaselake_nwr/)
