---
title: Setting Standards for Organic Seafood
slug: setting-standards-for-organic-seafood-0513
date: '2005-05-13'
category: Segments
image_url: https://loe.org/shows/../thisweek/050513shrimp.jpg
image_caption: OceanBoy Farms in Florida grows shrimp and is the only U.S. seafood company to receive USDA organic certification. They received the certification under the livestock rules.
summary: The demand for organic food is growing, and US sellers of fish and seafood want to jump on the bandwagon and certify their products organic. Currently, there are no organic standards for seafood but that's about to change. As Rachel Gotbaum reports, setting regulations for healthy fish is no easy process.
---
<!-- source: https://loe.org/shows/segments.html?programID=05-P13-00019&segmentID=3 -->
...
{% cue text="SOUND OF PADDLE WHEEL WATER PUMP" %}
...
- [OceanBoy Farms](http://www.oceanboy.com)
- [Environmental Defense](http://www.environmentaldefense.org)
- [USDA on Organic Fish](http://www.usda.gov/wps/portal/!ut/p/_s.7_0_A/7_0_1OB?navid=SEARCH&q=organic+fish)
