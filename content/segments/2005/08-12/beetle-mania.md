...
date: '2005-08-12'
category: Segments
image_url: https://loe.org/shows/../thisweek/050812NancyDahlSm.jpg
image_caption: 'Nancy Dahl kneels by a dead piñon tree. (Photo: Paul Ingles)'
summary: A sound artist in New Mexico has devised a unique way to save drought ridden pinon trees from falling under attack from the bark beetle. David Dunn listens to the tree to see if it's infested. Paul Ingles reports.
---
<!-- source: https://loe.org/shows/segments.html?programID=05-P13-00032&segmentID=4 -->
...
{% cue text="CRUNCH OF NEEDLES UNDERFOOT" %}
...
{% cue text="HIGHWAY SOUNDS, BIRDS CHIRPING" %}
...
{% cue text="WHOOSHING OF NON-INFESTED TREE SOUNDS" %}
...
{% cue text="NON-INFESTED TREE SOUNDS" %}
...
{% cue text="FASTER CLICKING OF BEETLE-INFESTED TREE" %}

INGLES: And before long, it sounds like quite a party in a fully infested tree.

{% cue text="LOTS OF CLICKING OF INFESTED TREE" %}
