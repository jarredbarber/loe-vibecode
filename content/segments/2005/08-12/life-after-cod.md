---
title: Life After Cod
slug: life-after-cod
date: '2005-08-12'
category: Segments
image_url: https://loe.org/shows/../thisweek/050812HbrDeepSm.jpg
image_caption: 'The vanished Newfoundland fishing community of Harbour Deep. Founded in the 17th century, its last residents left in 2002. (Photo: Fred Campbell)'
summary: A rare look from inside a community that has lost its longtime reason for being. Newfoundland producer Chris Brookes listens to what was lost and what has remained in two communities since the disastrous over-fishing of the region’s Atlantic cod.
---
<!-- source: https://loe.org/shows/segments.html?programID=05-P13-00032&segmentID=6 -->
...
{% cue text="MUSIC AND DANCING SOUNDS" %}
...
{% cue text="WOMAN’S VOICE HUMMING" %}
...
{% cue text="CAPTAIN ‘BE THERE IN 40 MINUTES…" %}

BROOKES: The community itself. It was Sunday.

{% cue text="CHURCH SINGING" %}
...
{% cue text="CRAFT SHOP NOISES, WOMAN TALKING" %}
...
{% cue text="CHEERING IN DANCE HALL" %}
...
{% cue text="All music original live recordings from producer/reporter Chris Brooks" %}
...
- [“Worlds of Difference”](http://homelands.org/worlds/)
