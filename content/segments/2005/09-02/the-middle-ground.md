...
date: '2005-09-02'
category: Segments
image_url: https://loe.org/shows/../thisweek/050902cows.jpg
image_caption: 'Cows in Pt. Reyes National Seashore. (Photo: Guy Hand Productions ©)'
summary: We tend to think of nature and modern agriculture as competing, often in conflict. But in West Marin County, California they're closing the divide. That's because people who live in West Marin decided decades ago that nature and agriculture can coexist and even flourish. Guy Hand reports.
---
<!-- source: https://loe.org/shows/segments.html?programID=05-P13-00035&segmentID=5 -->
...
{% cue text="CROWD NOISE CHANGES TO BIRDSONG" %}
...
{% cue text="SCRUBBING SOUNDS IN WATER" %}
...
{% cue text="SOUND OF GRABBING OYSTER SHELLS" %}
...
{% cue text="REGGAE MUSIC AND CONVERSATION" %}
...
{% cue text="TRUCK ENGINE STARTING" %}
...
{% cue text="MAN IN RESTAURANT SINGS A LINE: “Just remember it’s the farmer that feeds us all.” It’s a great song about….." %}
