...
slug: attention-shoppers
date: '2005-12-02'
category: Segments
summary: When sound artist Jonathan Mitchell returns to his mid-western hometown he often ends up at the mall with family and friends. He offers an audio portrait of today’s American commons.
---
<!-- source: https://loe.org/shows/segments.html?programID=05-P13-00048&segmentID=8 -->
...
{% cue text="UPBEAT ORGAN LOUNGE MUSIC" %}
...
{% cue text="AIRY SYNTHESIZER MUSIC" %}
...
{% cue text="HARP STRINGS STRUMMING UP, XYLOPHONE FOLLOWS" %}

MALES: Malls were being built, and we wanted to be involved.

{% cue text="ORGAN LOUNGE MUSIC, SLOWER TEMPO BACKBEAT" %}
...
{% cue text="CAR DOOR CLOSED, VIOLIN MALL MUSIC STARTS UP, HUM OF CROWD" %}
...
{% cue text="MELANGE OF VOICES, AS IF IN A DREAM SEQUENCE" %}
...
{% cue text="BIRD CALL, HARP STRINGS" %}
...
{% cue text="HARP STRINGS PUNCTUATED BY TRIANGLE" %}
...
{% cue text="MUZAK VERSION OF THE DOORS’ “LIGHT MY FIRE”; HUM OF SHOPPING CROWD" %}
...
{% cue text="ROMANTIC STRING MUSIC" %}
...
{% cue text="ROMANTIC STRINGS CONTINUE" %}
...
{% cue text="CRICKET SOUNDS, CAR SOUNDS" %}
...
{% cue text="BABY MAKING BABY-TALK" %}
...
{% cue text="CHIMES. TENSION-TEMPO STRING MUSIC" %}
...
{% cue text="BIRD SONG, DISTANT HIGHWAY SOUNDS" %}
...
{% cue text="MUSIC: Laurie Johnson “Happy Go Lively” from ‘Music For TV Dinners’ (Scamp – 1997)" %}
