...
{% cue text="CAR DOOR SLAMS, AIR BLOWING FROM HEATER; “Ah, the heater”" %}
...
{% cue text="MUSIC: Radiohead “A Wolf At The Door” from ‘Hail To The Thief’ (Capitol – 2003)" %}
...
{% cue text="MUSIC: Idaho &quot;Levitate, Part 2&quot; from ‘Levitate’ (Idaho Music – 2001)" %}
...
{% cue text="CAR DOOR SLAMS, CRUNCHING THROUGH SNOW" %}
...
{% cue text="MUSIC: Tom Vek &quot;Cover&quot; from ‘We have Sound’ (Star Time – 2005)" %}
...
{% cue text="MUSIC: Secret Chiefs 3 &quot;Welcome To The Theatron Animatronique’ from ‘Book Of Horizons’ (Mimicry - 2004)" %}
...
{% cue text="MUSIC: Idaho &quot;Scrawny&quot; from ‘Levitate’ (Idaho Music – 2001)" %}
...
{% cue text="MUSIC: The Shins “Young Pilgrims” from ‘Chutes Too Narrow’ (Sub Pop – 2003)" %}
...
{% cue text="MUSIC: Texas Red “Car Trouble’ from ‘Nothin’ Can Save Me Now’ (Cold Wind Records – 2004)" %}

{% cue text="CAR ENGINE TURNING OVER" %}
...
{% cue text="MUSIC: The Album Leaf “Moss Mountain” from ‘In A Safe Place’ (Sub Pop – 2004)" %}
...
- [IEEE Spectrum Radio](http://www.spectrum.ieee.org/radio)
