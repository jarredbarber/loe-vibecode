---
title: Wetland Mystery
slug: wetland-mystery
date: '2007-07-13'
category: Segments
summary: Marsh grass is dying in wetlands in the northeastern U.S. Scientists are having a hard time finding out what’s causing this “sudden wetland dieback.” Living on Earth’s Ashley Ahearn visited some sick wetlands and has our story.
---
<!-- source: https://loe.org/shows/segments.html?programID=07-P13-00028&segmentID=3 -->
...
{% cue text="MARSH BIRDS/WATER GURGLING" %}
...
{% cue text="FEET CRUNCHING ON MARSH GRASS" %}
...
{% cue text="HAMMONASSET MARSH – FOOTSTEPS IN MARSH" %}
...
{% cue text="SHOVEL IN MUCK, SLURPING AS SAMPLE COMES OUT" %}

ELMER: We’re the CSI of the plant world here.

{% cue text="SHOVEL SOUND TO COVER LAUGHING" %}
...
{% cue text="MUSIC: Cinematic Orchestra “Familiar Ground” from ‘Ma Fleur’ (Nonesuch Records – 2006)" %}

## Related Links

- [New England Sudden Wetland Dieback Information Page](http://wetland.neers.org/)
