...
{% cue text="MUSIC: drumbeats, whooshing sounds, and vocals" %}
...
{% cue text="RAPID, RHYTHMIC BEATS" %}

YOUNG: What is that in terms of the data?

{% cue text="BEATS CONTINUE" %}
...
{% cue text="SOUND LIKE SYMBOL CRASH WITH VOCALS" %}
...
{% cue text="SOUND LIKE SINGING OR HUMMING" %}
...
{% cue text="SOLAR WIND MUSIC CONTINUES" %}
...
{% cue text="MUSIC: Robert Alexander “Music From The Sun,” produced and composed by Robert Alexander" %}

## Related Links

- [The Solar and Heliospheric Research Group at University of Michigan.](http://solar-heliospheric.engin.umich.edu/ace/)
- [Composer Robert Alexander’s website](http://www.robertalexandermusic.com/)
