---
title: Operation Green Energy
slug: operation-green-energy
date: '2010-08-20'
category: Segments
image_url: https://loe.org/images/content/100416/brush.jpg
image_caption: 'Former cavalry scout Michael Farnum pulls up invasive plants. (Photo: George Cavallo)'
summary: American soldiers returning from war often struggle to readjust to civilian life. Today, many veterans are turning to environmental work and activism to make the transition. Host Jeff Young talks with veterans working for clean energy, creating green jobs, and healing their own wounds by restoring habitats.
---
<!-- source: https://loe.org/shows/segments.html?programID=10-P13-00034&segmentID=3 -->
...
{% cue text="SOUNDS OF HACKING AND DIGGING AT BUSHES" %}
...
{% cue text="SOUNDS OF CUTTING, HACKING “There’s a few salmonberries in there, so be careful...”" %}
...
{% cue text="SOUNDS OF SHOVELING AND RAKING" %}
...
{% cue text="SOUNDS OF SHOVEL CLINKS IN DIRT" %}
...
{% cue text="SOUND OF CLIPPERS CHOPPING VINES" %}
...
{% cue text="SOUNDS OF FREEWAY FADE" %}
...
{% cue text="LEARY CHATTING IN THE BACKGROUND" %}
...
{% cue text="BUS DRIVING AWAY" %}

## Related Links

- [Veterans Green Jobs](http://www.veteransgreenjobs.org)
- [Veterans Conservation Corp](http://www.volunteer.united-e-way.org/unitedwayspokane/org/10288622661.html)
- [Operation Free](http://www.operationfree.net/home/)
- [Vote Vets](http://www.votevets.org/index_html)
