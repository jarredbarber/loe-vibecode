...
slug: arctic-explorers-0224
date: '2012-02-24'
category: Segments
image_url: http://stream.loe.org/images/120224/top/top ice.jpg
image_caption: Arctic sea ice. (Courtesy of Fiamma Straneo)
...
---
<!-- source: https://loe.org/shows/segments.html?programID=12-P13-00008&segmentID=6 -->
...
{% cue text="MUSIC: MEKUBOLIM Zorn2" %}
...
{% cue text="MUSIC MEKUBOLIM ZORN3" %}

MILLMAN: Well they couldn't turn around and he was using that possibly as part of his ammunition.

{% cue text="CLIP FROM FILM: We stand now on the edge of discovery. This great bay must open somewhere and yield a passage. Let us thrust westward in the common triumph of raising the Indies!" %}
...
{% cue text="CLIP FROM FILM: Arrh now that you’re free of us master Hudson, you may sail westward for all you are worth! Mr. Green– it is not too late. Reconsider!" %}
...
{% cue text="SEAFARING SONG CONTINUES." %}

## Related Links

- [Mind Open Media](http://mindopenmedia.wordpress.com/)
