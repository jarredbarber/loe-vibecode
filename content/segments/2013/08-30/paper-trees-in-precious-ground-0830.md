---
title: Paper Trees in Precious Ground
slug: paper-trees-in-precious-ground-0830
date: '2013-08-30'
category: Segments
summary: "Two huge plantation industries are sweeping Indonesia: palm trees used to make oil, and acacia trees used to make paper. But most of the land left for plantations\_in the wake of deforestation is in peat forests -- land with the highest carbon content in the world. Plantations on peat have helped Indonesia become the world's third biggest greenhouse gas emitter. The debate over emissions from peatlands is most acute in Riau province, Sumatra. Ingrid Lobet reports."
---
<!-- source: https://loe.org/shows/segments.html?programID=13-P13-00035&segmentID=2 -->
...
{% cue text="BIRDS SINGING; OUTDOOR SOUNDS; GIBBON IN THE BACKGROUND" %}
...
{% cue text="ARMAN SPEAKING INDONESIAN" %}
...
{% cue text="JONOTORO SPEAKING INDONESIAN" %}
...
{% cue text="VOICES AND FACTORY SOUND" %}
...
{% cue text="SOUND OF PAPER CUTTER; STRAPPING MACHINE" %}
...
{% cue text="SOUND OF WALKING OVER DRY ORGANIC GROUND COVER" %}
...
{% cue text="MECHANICAL SOUND OF CRANE" %}
...
{% cue text="CRANE SOUND CONTINUES" %}
...
{% cue text="SOUND OF GENERATOR; HAMMERING ON WOOD" %}
...
{% cue text="WOMAN TRANSLATES INTO INDONESIAN OVER P.A." %}
...
- [Recent Scientific Paper on Peat Emissions](http://www.nature.com/ngeo/journal/v2/n11/full/ngeo671.html)
- [Asia Pacific Resources International Limited](http://www.aprilasia.com/index.php)
- [Peat Experts Wetlands International](http://www.wetlands.org/)
- [Environmental Collaborative Group in Riau Eyes on the Forest](http://www.eyesontheforest.or.id/)
- [Asia Pulp and Paper](http://www.asiapulppaper.com/)
- [Greenpeace Southeast Asia](http://www.greenpeace.org/seasia/en/)
