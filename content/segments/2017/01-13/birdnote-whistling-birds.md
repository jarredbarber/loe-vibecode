---
title: 'BirdNote: Whistling Birds'
slug: birdnote-whistling-birds
date: '2017-01-13'
category: Segments
image_url: https://loe.org/content/2017-01-13/BIRDNOTE-Eastern-Wood-Pewee.jpg
image_caption: 'Eastern-wood Pewee (Photo: Joanne Kamo)'
summary: Birds can squawk, trill, or chirp, and a few whistle. As Michael Stein points out, those are often the easiest ones for humans to imitate.
---
<!-- source: https://loe.org/shows/segments.html?programID=17-P13-00002&segmentID=5 -->
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/195787/audio", label="Olive-sided Flycatcher" %}
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/130470/audio", label="Northern Saw-whet Owl song" %}
...
{% cue text="Narrator copies." %}

Finally, here’s a bird that whistles its heart out.  

{% cue text="From Bird Songs of the Pacific Northwest (Keller and Vyn; a Cornell Lab publication), Pigeon Guillemot" %}
...
{% cue text="MUSIC: Ronnie Ronalde, “In a Monastery Garden” on Route 86, Albert William Ketelby, Columbia Records" %}

CURWOOD: And if you like it, you can whistle on over to our website for some pictures.

## Related Links

- [Listen on the BirdNote website](http://birdnote.org/show/birds-whistle)
- [About the Olive-Sided Flycatcher](https://www.allaboutbirds.org/guide/Olive-sided_Flycatcher/id)
- [About the Eastern-wood Pewee](https://www.allaboutbirds.org/guide/Eastern_Wood-Pewee/id)
- [About the Northern Saw-whet Owl](https://www.allaboutbirds.org/guide/Northern_Saw-whet_Owl/id)
- [About the Pigeon Guillemot](https://www.allaboutbirds.org/guide/Pigeon_Guillemot/id)
