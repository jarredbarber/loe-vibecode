---
title: 'BirdNote: Thieving Frigatebirds'
slug: birdnote-thieving-frigatebirds-0818
date: '2017-08-18'
category: Segments
image_url: https://loe.org/content/2017-04-07/BIRDNOTE-Frigatebird-Attacks-Tropicbird--Neil-Winkelmann.jpg
image_caption: 'A frigatebird attacks a seabird for its meal. (Photo: Neil Winkelmann)'
summary: Some seabirds are brilliant at catching fish, but as Mary McCann explains, blue-footed boobies need to watch out for hungry thieving Frigatebirds.
---
<!-- source: https://loe.org/shows/segments.html?programID=17-P13-00033&segmentID=3 -->

## Transcript

{% cue text="MUSIC: BIRDNOTE® THEME" %}

CURWOOD: One of the most glorious sights of tropical oceans is the vision of the  
Magnificent Frigatebird soaring over the waves. But as Mary McCann points out in today’s BirdNote, sometimes the way these fork-tailed creatures behave is – well, less than magnanimous.

http://birdnote.org/show/frigatebirds-kleptoparasitism  
BirdNote®  
Frigatebirds’ Kleptoparasitism  

{% cue text="Featured bird sound/audio" %}

MCCANN: Some birds are masters at catching fish. In the warmer regions of the world’s oceans, large seabirds called “boobies” plunge headfirst into the water, snatching fish in their dagger-shaped bills. But as a booby flies up from the waves with a fish now in its gullet, there may be another big seabird, a frigatebird, waiting overhead, with its eye on the booby and on the booby’s fresh catch.

{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/6036/audio", label="Red-footed Booby aggressive call", duration=".32-.33" %}
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/136232/audio", label="Magnificent Frigatebird", duration="0.04-.06" %}
...
- [Listen on the BirdNote website](http://birdnote.org/show/frigatebirds-kleptoparasitism)
- [More about Frigatebirds from the Cornell Lab of Ornithology’s All About Birds](https://www.allaboutbirds.org/guide/Magnificent_Frigatebird/id)
- [Another BirdNote about Frigatebirds](http://www.loe.org/shows/segments.html?programID=16-P13-00049&segmentID=6)
