---
title: Hormone Disruptors Linked To Genital Changes and Sexual Preference
slug: hormone-disruptors-linked-to-genital-changes-and-sexual-preference-0818
date: '2017-08-18'
category: Segments
image_url: https://loe.org/images/content/110107/Hayes 2.jpg
summary: Scientists are continuing to sound the alarm about some common chemicals, including the herbicide atrazine, and link them to changes in reproductive health and development. Endocrine disrupting toxic chemicals have been found to feminize male frogs and cause homosexual behavior. Ashley Ahearn reports on how these substances may be affecting human development and behavior.
---
<!-- source: http://www.loe.org/shows/segments.html?programID=11-P13-00001&segmentID=7 -->
...
{% cue text="DOOR OF FROG LAB ROOM OPENS, VENTILATOR FAN RUNNING" %}

HAYES: So these are the South African Claw frog.

{% cue text="WATER SLOSHING IN TANK" %}
...
{% cue text="SOUND OF FROG TANK ROOM" %}
...
{% cue text="CAFETERIA SOUNDS AT OAKLAND CHILDREN’S HOSPITAL" %}
...
{% cue text="ELEVATOR DOOR, HALLWAY, PHONE RINGS" %}
...
{% cue text="BOOTS ON WOODEN PORCH" %}
...
{% cue text="MICROWAVE DOOR OPENS AND SHUTS, BUTTONS BEEP AND MICROWAVE STARTS UP" %}

AHEARN: At seven years old, Alice's son’s red head is just above counter level.

{% cue text="FINISHES BEEPS, DOOR OPENS AND SHUTS AGAIN" %}
...
- [A study that looks at hypospadias and endocrine disruptors.](http://ehp03.niehs.nih.gov/article/fetchArticle.action?articleURI=info:doi/10.1289/ehp.011091175)
- [Hypospadias and Epispadias Association](http://heainfo.org/)
- [Dr. Tiger Howard Devore](http://www.tigerhowarddevorephd.com/)
- [Tyrone Hayes' research: Hermaphroditic, demasculinized frogs after exposure to the herbicide atrazine at low ecologically relevant doses](http://www.pnas.org/content/99/8/5476.abstract)
- [Tyrone Hayes' research: Herbicides: Feminization of male frogs in the wild](http://www.nature.com/nature/journal/v419/n6910/full/419895a.html?lang=en)
