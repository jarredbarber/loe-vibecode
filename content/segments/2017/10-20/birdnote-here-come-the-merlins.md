...
summary: The Merlin is one of the world’s smallest falcons yet it’s something of a trailblazer. Rising global temperatures are forcing species to head north, but as BirdNote®’s Mary McCann reports, these adaptive predators have begun to move south to occupy the abandoned homes of other avian migrants.
---
<!-- source: https://loe.org/shows/segments.html?programID=17-P13-00042&segmentID=4 -->
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/197047/audio", label="Merlin calling", duration="0.19-.22" %}
...
![The Merlin’s migratory patterns actually run counter to the direction of rising temperatures. Scientists have found that these small predators are nesting further south, even as most birds are moving north. (Photo: Gregg Thompson)](https://loe.org/content/2017-10-20/BIRDNOTE-Merlin-takes-flight.jpg)
...
{% audio src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/105837/audio", label="Merlin call", duration="0.15-.17" %}
...
- [The “Here Come the Merlins” story on the BirdNote® website](https://loe.org/shows/ http://birdnote.org/show/here-come-merlins)
- [About the Merlin from the Cornell Lab of Ornithology](https://www.allaboutbirds.org/guide/Merlin/id)
