---
title: Repairing Puerto Rico’s Corals
slug: repairing-puerto-ricos-corals-0720
date: '2018-07-20'
category: Segments
image_url: https://loe.org/content/2018-07-20/PRCORALS_zip-tie_corals.jpg
image_caption: 'Grupo Vidas workers have used zip ties to reattach hundreds of coral fragments to the reef near Vega Baja. (Photo: Ricardo Loreano)'
summary: Roughly 10 percent of Puerto Rico’s corals were broken and damaged by Hurricane Maria in 2017. Corals are a first line of defense against storm surges and a critical habitat for juvenile fish but face an uphill battle against warming seas, ocean acidification and ship groundings. As Host Bobby Bascomb reports, Puerto Ricans are finding ways to give corals a fighting chance by reattaching healthy fragments.
---
<!-- source: https://loe.org/shows/segments.html?programID=18-P13-00029&segmentID=2 -->
...
![The Grupo Vidas crew taking a break from their coral restoration work. (Photo: Bobby Bascomb)](https://loe.org/content/2018-07-20/PRCORALS_grupo_vidas.jpg)
...
Salvador points towards the water…
...
She’s holding a white milk crate with all the tools the crew will need for their morning’s work.
...
![The beach near Vega Baja, Puerto Rico. (Photo: Bobby Bascomb)](https://loe.org/content/2018-07-20/PRCORALS_beach.jpg)
...
S. LOREANO: No, no – just in case.

{% cue text="SFX – WATER SPLASHING, WALKING IN THE WATER UNDER NEXT GRAPH" %}
...
{% cue text="SFX – SPLASHING SOUND" %}

Once the water is knee-deep, we splash in and swim about 500 feet to the reef.

{% cue text="SFX – BREATHING SOUNDS" %}

A rainbow of fish greets us – green fish with florescent blue heads, black fish with yellow stripes, green fish with pink stripes.
...
{% cue text="SFX – SCRAPING SOUND" %}

A worker named Ernesto is already hard at work.
...
{% cue text="SFX – UNDERWATER BREATHING SOUNDS CROSS FADE TO END GRAPH WITH DUNE AMBI" %}
...
![Elk horn coral are part of a vital reef ecosystem that provide habitat for fish. (Photo: Sean Nash)](https://loe.org/content/2018-07-20/PRCORALS_elk_horn_coral.jpg)
...
BASCOMB: Projects like this have actually been going on for nearly 20 years on a small scale.
...
- [Índice | Lifeguards of Our Reefs](https://translate.google.com/translate?hl=en&sl=es&u=http://www.indicepr.com/noticias/2013/05/09/house/4443/salvavidas-de-nuestros-arrecifes/&prev=search)
- [Grupo V.I.D.A.S.](https://www.facebook.com/groups/139894882692230/)
- [NOAA page on Corals](https://www.coris.noaa.gov/portals/puertorico.html)
