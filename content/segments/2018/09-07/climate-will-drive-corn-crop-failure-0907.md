---
title: Climate Will Drive Corn Crop Failure
slug: climate-will-drive-corn-crop-failure-0907
date: '2018-09-07'
category: Segments
image_url: https://loe.org/content/2018-06-29/CROPFAILURE_Craving_for_Corn_.jpg
image_caption: 'A local street vendor sells corn in Mumbai. Corn crop failures could spell bad news for the billions around the globe who depend on maize products. (Photo: Himanshu Singh Gurjar, CC BY-SA 4.0)'
summary: Corn, also known as Maize, is the world’s most produced food crop. But it is headed for trouble as the world warms. A new study published in Proceedings of the National Academy of Sciences finds that climate change increases the risk of simultaneous corn crop failures. Lead scientist Michelle Tigchelaar explains to Host Savannah Christiansen how different climate warming scenarios could impact global maize production.
---
<!-- source: https://loe.org/shows/segments.html?programID=18-P13-00026&segmentID=3 -->
...
CHRISTIANSEN: And your study in particular, what does it say about by how much these corn crops will fail given the different levels of warming.

![Corn is the most produced crop in the world and is used for food, livestock feed, and biofuel, among other uses. (Photo: Aaron Burden, Wikimedia Commons)](https://loe.org/content/2018-06-29/CROPFAILURE_Maize-photo-.jpg)
...
TIGCHELAAR: Yeah, well, looking at say the probability that the four main corn-growing countries have a massive crop failure at the same time. Currently, we calculated that that probability is zero. There is very little chance that that would happen. In a two degree warmer world that probability goes up to seven percent. In a four degree warmer world, all things being equal, we calculated that that probability would be 86 percent. So, it really does matter if we have two or four degrees of warming. It's not just any warming is bad or any warming doesn't matter. It really matters where on that spectrum we land.

CHRISTIANSEN: Why look specifically at corn, or maize as it is otherwise known. Why is this crop so important?

![Among its many uses, corn or maize is commonly produced as feed or fodder for livestock, such as sheep. (Photo: CSIRO Science, CC BY 3.0)](https://loe.org/content/2018-06-29/CROPFAILURE_Sheep_Eating.jpg)
...
CHRISTIANSEN: So, how would corn failures impact different people around the globe? In other words, who will be hit the hardest if these failures happen?
...
- [Inside Climate News | "Climate Change Could Lead to Major Crop Failures in World's Biggest Corn Regions"](https://insideclimatenews.org/news/11062018/climate-change-research-food-security-agriculture-impacts-corn-vegetables-crop-prices?utm_source=EHN&utm_campaign=c14fa2ca20-RSS_EMAIL_CAMPAIGN&utm_medium=email&utm_term=0_8573f35474-c14fa2ca20-99403717)
- [Carbon Brief | Climate Change and Food Shocks](https://www.carbonbrief.org/guest-post-climate-change-could-heighten-risk-global-food-production-shocks)
- [Michelle Tigchelaar website](https://michelletigchelaar.weebly.com/)
