...
{% cue text="Fade out bird calls abruptly" %}
...
{% cue text="Spix macaw habitat soundscape" %}
...
- [This story and more on the BirdNote® website](https://www.birdnote.org/listen/shows/return-extinct-little-blue-macaw)
