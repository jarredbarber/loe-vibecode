...
![An artist’s rendering of the James Webb Space Telescope (JWST) above the Earth. The large mirrors on the telescope help it to collect light even from the distant reaches of the Universe. (Photo: NASA/dima\_zel, Wikimedia Commons, CC BY 4.0)](https://loe.org/content/2024-03-29/SPACE_jwst.jpg)
...
- [Read the University of Cambridge announcement of the discovery](https://www.cam.ac.uk/research/news/astronomers-detect-oldest-black-hole-ever-observed)
- [Access the study in Nature](https://www.nature.com/articles/s41586-024-07052-5.epdf)
- [View a gallery of images from the James Webb Space Telescope](https://webbtelescope.org/images)
