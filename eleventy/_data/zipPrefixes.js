// Maps the first 3 digits of a US ZIP code to a 2-letter state code.
// Source: USPS ZIP code prefix assignments (publicly documented).
// State-level accuracy only — sufficient for "find the nearest LoE station" v1.
//
// A handful of 3-digit prefixes span two states; we pick the dominant one.
// Prefixes assigned to APO/FPO/territories (e.g. 006-009 PR, 800/801 fragments)
// either map to the dominant state or are omitted (lookup falls through to null).

const ZIP3_TO_STATE = {
    // 005 NY, 006-009 PR (skip)
    '005': 'NY',
    // 010-027 MA, 028-029 RI
    '010':'MA','011':'MA','012':'MA','013':'MA','014':'MA','015':'MA','016':'MA','017':'MA','018':'MA','019':'MA',
    '020':'MA','021':'MA','022':'MA','023':'MA','024':'MA','025':'MA','026':'MA','027':'MA',
    '028':'RI','029':'RI',
    // 030-038 NH, 039 ME (some), 040-049 ME
    ...
    // 320-349 FL (320-339, 342, 344, 346-347, 349); 350-369 AL
    ...
    // 630-658 MO
    '630':'MO','631':'MO','633':'MO','634':'MO','635':'MO','636':'MO','637':'MO','638':'MO','639':'MO','640':'MO',
    '641':'MO','644':'MO','645':'MO','646':'MO','647':'MO','648':'MO','650':'MO','651':'MO','652':'MO','653':'MO',
    '654':'MO','655':'MO','656':'MO','657':'MO','658':'MO',
    // 660-679 KS
    '660':'KS','661':'KS','662':'KS','664':'KS','665':'KS','666':'KS','667':'KS','668':'KS','669':'KS','670':'KS',
    '671':'KS','672':'KS','673':'KS','674':'KS','675':'KS','676':'KS','677':'KS','678':'KS','679':'KS',
    // 680-693 NE
    ...
    // 730-749 OK
    '730':'OK','731':'OK','734':'OK','735':'OK','736':'OK','737':'OK','738':'OK','739':'OK','740':'OK','741':'OK',
    ...
    // 850-865 AZ
    '850':'AZ','851':'AZ','852':'AZ','853':'AZ','855':'AZ','856':'AZ','857':'AZ','859':'AZ','860':'AZ','863':'AZ',
    '864':'AZ','865':'AZ',
    // 870-884 NM
    ...
    '952':'CA','953':'CA','954':'CA','955':'CA','957':'CA','958':'CA','959':'CA','960':'CA','961':'CA',
    // 967-968 HI
    '967':'HI','968':'HI',
    // 970-979 OR
